...
<template>
  <div>
    ...
    <GamifyDialog
      ...
      id="confirm-delete"
      title="かくにん"
      :description="`ほんとうに　${route.params.name}と　わかれるんだな！　この　そうさは　とりけせないぞ！`"
      @close="onCloseDelete"
    >
